...
const PageList_ModuleMaster = () => {
    ...
    const handleAdd = () => {
        navigate("/addEdit_ModuleMaster", { state: { Id: 0 } });
    };

    const handleEdit = (id: number | string) => {
        if (!id) return;
        navigate("/addEdit_ModuleMaster", { state: { Id: id } });
    };
    ...
    const filteredList = useMemo(() => {
        ...
        return list.filter((item: any) =>
            ...
            String(item?.Path ?? "").toLowerCase().includes(search)
        );
        ...
        <div className="page-body">
            ...
            <Container fluid>
                <Row>
                    <Col xs="12">
                        <Card>
                            <CardHeaderCommon title="Module List" tagClass="card-title mb-0" />
                            <CardBody>
                                <Row className="mb-3">
