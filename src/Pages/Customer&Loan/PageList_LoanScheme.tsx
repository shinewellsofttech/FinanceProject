...
const PageList_LoanScheme = () => {
  ...
  const loadData = useCallback(() => {
    ...
    Fn_FillListData(dispatch, setState, "dataList", LIST_API_URL).catch((error) => {
      console.error("Failed to load loan scheme list:", error);
    ...
    <div className="page-body">
      ...
      <Container fluid>
        <Row>
          <Col xs="12">
            <Card>
              <CardHeaderCommon title="Loan Scheme List" tagClass="card-title mb-0" />
              <CardBody>
                <Row className="mb-3">
...
export default PageList_LoanScheme;
